...
Deserializers["TutorialManager"] = function (request, data, root) {
  ...
  i512.oldStarter = new pc.Vec2( i513[9], i513[10] )
  i512.starterPos = new pc.Vec2( i513[11], i513[12] )
  i512.baseP = new pc.Vec2( i513[13], i513[14] )
  request.r(i513[15], i513[16], 0, i512, 'dragger')
  var i515 = i513[17]
  ...
  i512.basePos = i516
  i512.currentTimer = i513[19]
  i512.maxTimer = i513[20]
  i512.timerCalled = !!i513[21]
  return i512
}
...
Deserializers["UnityEngine.Events.ArgumentCache"] = function (request, data, root) {
  var i536 = root || request.c( 'UnityEngine.Events.ArgumentCache' )
  var i537 = data
  request.r(i537[0], i537[1], 0, i536, 'm_ObjectArgument')
  i536.m_ObjectArgumentAssemblyTypeName = i537[2]
  i536.m_IntArgument = i537[3]
  i536.m_FloatArgument = i537[4]
  i536.m_StringArgument = i537[5]
  i536.m_BoolArgument = !!i537[6]
  return i536
}

Deserializers["UnityEngine.UI.Navigation"] = function (request, data, root) {
  var i538 = root || request.c( 'UnityEngine.UI.Navigation' )
  var i539 = data
  i538.m_Mode = i539[0]
  i538.m_WrapAround = !!i539[1]
  request.r(i539[2], i539[3], 0, i538, 'm_SelectOnUp')
  request.r(i539[4], i539[5], 0, i538, 'm_SelectOnDown')
  request.r(i539[6], i539[7], 0, i538, 'm_SelectOnLeft')
  request.r(i539[8], i539[9], 0, i538, 'm_SelectOnRight')
  return i538
}

Deserializers["UnityEngine.UI.ColorBlock"] = function (request, data, root) {
  var i540 = root || request.c( 'UnityEngine.UI.ColorBlock' )
  var i541 = data
  i540.m_NormalColor = new pc.Color(i541[0], i541[1], i541[2], i541[3])
  i540.m_HighlightedColor = new pc.Color(i541[4], i541[5], i541[6], i541[7])
  i540.m_PressedColor = new pc.Color(i541[8], i541[9], i541[10], i541[11])
  i540.m_SelectedColor = new pc.Color(i541[12], i541[13], i541[14], i541[15])
  i540.m_DisabledColor = new pc.Color(i541[16], i541[17], i541[18], i541[19])
  i540.m_ColorMultiplier = i541[20]
  i540.m_FadeDuration = i541[21]
  return i540
}

Deserializers["UnityEngine.UI.SpriteState"] = function (request, data, root) {
  var i542 = root || request.c( 'UnityEngine.UI.SpriteState' )
  var i543 = data
  request.r(i543[0], i543[1], 0, i542, 'm_HighlightedSprite')
  request.r(i543[2], i543[3], 0, i542, 'm_PressedSprite')
  request.r(i543[4], i543[5], 0, i542, 'm_SelectedSprite')
  request.r(i543[6], i543[7], 0, i542, 'm_DisabledSprite')
  return i542
}

Deserializers["UnityEngine.UI.AnimationTriggers"] = function (request, data, root) {
  var i544 = root || request.c( 'UnityEngine.UI.AnimationTriggers' )
  var i545 = data
  i544.m_NormalTrigger = i545[0]
  i544.m_HighlightedTrigger = i545[1]
  i544.m_PressedTrigger = i545[2]
  i544.m_SelectedTrigger = i545[3]
  i544.m_DisabledTrigger = i545[4]
  return i544
}

Deserializers["HexBase"] = function (request, data, root) {
  var i546 = root || request.c( 'HexBase' )
  var i547 = data
  var i549 = i547[0]
  var i548 = new (System.Collections.Generic.List$1(Bridge.ns('HexBase')))
  for(var i = 0; i < i549.length; i += 2) {
  request.r(i549[i + 0], i549[i + 1], 1, i548, '')
  }
  i546.nearbyBases = i548
  request.r(i547[1], i547[2], 0, i546, 'occupiedHex')
  i546.occupied = !!i547[3]
  return i546
}
...
Deserializers["GameManager"] = function (request, data, root) {
  var i556 = root || request.c( 'GameManager' )
  var i557 = data
  var i559 = i557[0]
  var i558 = new (System.Collections.Generic.List$1(Bridge.ns('UnityEngine.Material')))
  for(var i = 0; i < i559.length; i += 2) {
  request.r(i559[i + 0], i559[i + 1], 1, i558, '')
  }
  i556.tileMats = i558
  request.r(i557[1], i557[2], 0, i556, 'Ground')
  request.r(i557[3], i557[4], 0, i556, 'replacerParent')
  request.r(i557[5], i557[6], 0, i556, 'hexNorth')
  var i561 = i557[7]
  var i560 = new (System.Collections.Generic.List$1(Bridge.ns('HexBase')))
  ...
  i556.hexDraggers = i562
  request.r(i557[9], i557[10], 0, i556, 'emptyDrag')
  var i565 = i557[11]
  ...
  i556.currentMixers = i564
  request.r(i557[12], i557[13], 0, i556, 'currentReplacer')
  var i567 = i557[14]
  var i566 = new (System.Collections.Generic.List$1(Bridge.ns('HexGroup')))
  for(var i = 0; i < i567.length; i += 2) {
  request.r(i567[i + 0], i567[i + 1], 1, i566, '')
  }
  i556.nearbyReplacerHexes = i566
  i556.IsTransferring = !!i557[15]
  i556.firstFullStack = !!i557[16]
  request.r(i557[17], i557[18], 0, i556, 'currentHexDrag')
  request.r(i557[19], i557[20], 0, i556, 'hexDragPrefab')
  request.r(i557[21], i557[22], 0, i556, 'hexDragParent')
  return i556
}

Deserializers["AudioManager"] = function (request, data, root) {
  var i570 = root || request.c( 'AudioManager' )
  var i571 = data
  request.r(i571[0], i571[1], 0, i570, 'library')
  i570.sfxPoolSize = i571[2]
  return i570
}

Deserializers["DontDestroy"] = function (request, data, root) {
  var i572 = root || request.c( 'DontDestroy' )
  var i573 = data
  return i572
}

Deserializers["CTAManager"] = function (request, data, root) {
  var i574 = root || request.c( 'CTAManager' )
  var i575 = data
  i574.GameOver = !!i575[0]
  request.r(i575[1], i575[2], 0, i574, 'WinPanel')
  request.r(i575[3], i575[4], 0, i574, 'LosePanel')
  i574.iosLink = i575[5]
  i574.androidLink = i575[6]
  return i574
}
...
Deserializers.buildID = "ccf68e29-6564-4798-a3ac-87602ca6daec";
