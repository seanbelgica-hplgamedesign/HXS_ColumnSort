...
public class GameManager : MonoBehaviour
{
    ...
    public void UpdateRandomizerChances()
    {
        ...
        foreach (HexTiles tiles in replacer.HexTiles)
        {
            ...
            {
                case 1: red += tileChances; break;
                case 2: violet += tileChances; break;
                case 3: blue += tileChances; break;
                case 4: cyan += tileChances; break;
                case 5: green += tileChances; break;
                case 6: yellow += tileChances; break;
                case 7: orange += tileChances; break;
            }
        }
